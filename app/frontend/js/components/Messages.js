...
export const AssistantMessage = React.memo(function AssistantMessage({markdown}) {
  return (
...
export function SystemMessage({text}) {
  return <div className="mt-3 text-center text-xs text-zinc-500 first:mt-0">{text}</div>
}

export function StreamingMessage({markdown}) {
  return (
